...
evol.evolABAkpert.argtypes = (ct.POINTER(ct.c_char_p), ct.POINTER(ct.c_char_p), ct.c_int, ct.c_int, ct.c_longdouble, ct.POINTER(ct.c_char_p), ct.POINTER(ct.c_char_p), ct.c_int, ct.POINTER(ct.c_char_p), ct.POINTER(ct.c_char_p), ct.c_int, ct.c_char_p, ct.c_int)
evol.evolABAkpert_errH.argtypes = (ct.POINTER(ct.c_char_p), ct.POINTER(ct.c_char_p), ct.c_int, ct.c_int, ct.c_longdouble, ct.POINTER(ct.c_char_p), ct.POINTER(ct.c_char_p), ct.c_int, ct.POINTER(ct.c_char_p), ct.POINTER(ct.c_char_p), ct.c_int, ct.POINTER(ct.c_longdouble))
evol.evolABAkpert_errQ.argtypes = (ct.POINTER(ct.c_char_p), ct.POINTER(ct.c_char_p), ct.c_int, ct.c_int, ct.c_longdouble, ct.POINTER(ct.c_char_p), ct.POINTER(ct.c_char_p), ct.c_int, ct.POINTER(ct.c_char_p), ct.POINTER(ct.c_char_p), ct.c_int, ct.POINTER(ct.c_longdouble))
evol.evolABAkpert_errHQ.argtypes = (ct.POINTER(ct.c_char_p), ct.POINTER(ct.c_char_p), ct.c_int, ct.c_int, ct.c_longdouble, ct.POINTER(ct.c_char_p), ct.POINTER(ct.c_char_p), ct.c_int, ct.POINTER(ct.c_char_p), ct.POINTER(ct.c_char_p), ct.c_int, ct.POINTER(ct.c_longdouble), ct.POINTER(ct.c_longdouble))
